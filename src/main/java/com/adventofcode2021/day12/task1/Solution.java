package com.adventofcode2021.day12.task1;
...
public class Solution {
    ...
    public static int run(String[] input) {
        ...
        return countDistinctPaths(neighborsMap, visited);
    }
    ...
    private static int countDistinctPaths(Map<Vertex, List<Vertex>> neighborsMap, LinkedList<Vertex> visited) {
        ...
        for (Vertex vertex : neighbors) {
            ...
            if (!vertex.isEnd() && !visited.contains(vertex) || vertex.canBeVisitedMoreThanOnce()) {
                visited.add(vertex);
                count += countDistinctPaths(neighborsMap, visited);
            }
        }
